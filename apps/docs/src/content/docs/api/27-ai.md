...
|----------|------|------|-----------|---------|
| `ai.transcribe` | Mutation | Yes | Not Started | Generate video transcript |
| `ai.getTranscript` | Query | Yes | Not Started | Get transcript for video |

### Growth Endpoints
| Endpoint | Type | Auth | Completed | Purpose | Priority |
|----------|------|------|-----------|---------|----------|
| `ai.detectScenes` | Mutation | Yes | Not Started | Auto-detect scene changes | High |
| `ai.generateSummary` | Mutation | Yes | Not Started | Summarize video content | High |
| `ai.search` | Query | Yes | Not Started | Semantic video search | High |
| `ai.suggestTags` | Query | Yes | Not Started | Auto-suggest tags | Medium |
| `ai.analyzeContent` | Mutation | Yes | Not Started | Content analysis (objects, faces) | Medium |

### Scale Endpoints
| Endpoint | Type | Auth | Completed | Purpose | Priority |
|----------|------|------|-----------|---------|----------|
| `ai.generateChapters` | Mutation | Yes | Not Started | Auto-create video chapters | Medium |
| `ai.translateTranscript` | Mutation | Yes | Not Started | Translate to other languages | Medium |
| `ai.generateCaptions` | Mutation | Yes | Not Started | Generate caption file | Medium |
| `ai.suggestEdits` | Query | Yes | Not Started | AI-powered edit suggestions | Low |
| `ai.compareVersions` | Query | Yes | Not Started | AI version diff analysis | Low |
...
- [Annotations API](./11-annotations) - Manual annotations
